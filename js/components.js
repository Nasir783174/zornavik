      ...
      <nav class="primary-nav" aria-label="Primary navigation">
        ...
        <div class="nav-item">
          ...
          <div class="dropdown" role="menu">
            <a href="${rootPath}pages/vacuums-for-floors.html?sub=best-for-hardwood" class="dropdown-link" role="menuitem">Best for Hardwood Floors</a>
            <a href="${rootPath}pages/vacuums-for-floors.html?sub=best-for-carpet" class="dropdown-link" role="menuitem">Best for Carpet</a>
            <a href="${rootPath}pages/vacuums-for-floors.html?sub=best-for-tile" class="dropdown-link" role="menuitem">Best for Tile Floors</a>
            <a href="${rootPath}pages/vacuums-for-floors.html?sub=best-for-mixed" class="dropdown-link" role="menuitem">Best for Mixed Flooring</a>
          </div>
        </div>
        ...
        <div class="nav-item">
          ...
          <div class="dropdown" role="menu">
            <a href="${rootPath}pages/cleaning-needs.html?sub=pet-hair" class="dropdown-link" role="menuitem">Best for Pet Hair</a>
            <a href="${rootPath}pages/cleaning-needs.html?sub=cordless" class="dropdown-link" role="menuitem">Best Cordless Vacuums</a>
            <a href="${rootPath}pages/cleaning-needs.html?sub=robot" class="dropdown-link" role="menuitem">Best Robot Vacuums</a>
            <a href="${rootPath}pages/cleaning-needs.html?sub=handheld" class="dropdown-link" role="menuitem">Best Handheld Vacuums</a>
            <a href="${rootPath}pages/cleaning-needs.html?sub=upright" class="dropdown-link" role="menuitem">Best Upright Vacuums</a>
          </div>
        </div>
        ...
        <div class="nav-item">
          ...
          <div class="dropdown" role="menu">
            <a href="${rootPath}pages/by-home-type.html?sub=apartments" class="dropdown-link" role="menuitem">For Apartments</a>
            <a href="${rootPath}pages/by-home-type.html?sub=large-homes" class="dropdown-link" role="menuitem">For Large Homes</a>
            <a href="${rootPath}pages/by-home-type.html?sub=pet-owners" class="dropdown-link" role="menuitem">For Pet Owners</a>
            <a href="${rootPath}pages/by-home-type.html?sub=allergy-sufferers" class="dropdown-link" role="menuitem">For Allergy Sufferers</a>
          </div>
        </div>
...
<nav class="mobile-nav" id="mobile-nav" aria-label="Mobile navigation">
  <div class="mobile-nav-group">
    ...
    <a href="${rootPath}pages/vacuums-for-floors.html?sub=best-for-hardwood" class="mobile-nav-link">Best for Hardwood Floors</a>
    <a href="${rootPath}pages/vacuums-for-floors.html?sub=best-for-carpet" class="mobile-nav-link">Best for Carpet</a>
    <a href="${rootPath}pages/vacuums-for-floors.html?sub=best-for-tile" class="mobile-nav-link">Best for Tile Floors</a>
    <a href="${rootPath}pages/vacuums-for-floors.html?sub=best-for-mixed" class="mobile-nav-link">Best for Mixed Flooring</a>
  </div>
  <div class="mobile-nav-group">
    <div class="mobile-nav-label">Cleaning Needs</div>
    <a href="${rootPath}pages/cleaning-needs.html?sub=pet-hair" class="mobile-nav-link">Best for Pet Hair</a>
    <a href="${rootPath}pages/cleaning-needs.html?sub=cordless" class="mobile-nav-link">Best Cordless Vacuums</a>
    <a href="${rootPath}pages/cleaning-needs.html?sub=robot" class="mobile-nav-link">Best Robot Vacuums</a>
    <a href="${rootPath}pages/cleaning-needs.html?sub=handheld" class="mobile-nav-link">Best Handheld Vacuums</a>
    <a href="${rootPath}pages/cleaning-needs.html?sub=upright" class="mobile-nav-link">Best Upright Vacuums</a>
  </div>
  <div class="mobile-nav-group">
    <div class="mobile-nav-label">By Home Type</div>
    <a href="${rootPath}pages/by-home-type.html?sub=apartments" class="mobile-nav-link">For Apartments</a>
    <a href="${rootPath}pages/by-home-type.html?sub=large-homes" class="mobile-nav-link">For Large Homes</a>
    <a href="${rootPath}pages/by-home-type.html?sub=pet-owners" class="mobile-nav-link">For Pet Owners</a>
    <a href="${rootPath}pages/by-home-type.html?sub=allergy-sufferers" class="mobile-nav-link">For Allergy Sufferers</a>
  </div>
  <div class="mobile-nav-group">
  ...
  <div class="container">
    <div class="footer-grid">
      ...
      <div class="footer-col">
        <h5>Top Reviews</h5>
        <ul class="footer-links">
          <li><a href="${rootPath}posts/best-cordless-vacuums-2026.html" class="footer-link">Best Cordless Vacuums 2026</a></li>
          <li><a href="${rootPath}posts/best-vacuums-pet-hair-2026.html" class="footer-link">Best for Pet Hair 2026</a></li>
          <li><a href="${rootPath}posts/best-robot-vacuum-mop-2026.html" class="footer-link">Best Robot Vacuums 2026</a></li>
          <li><a href="${rootPath}posts/best-dyson-cordless-2026.html" class="footer-link">Best Dyson Cordless</a></li>
          <li><a href="${rootPath}posts/best-vacuum-hardwood-floors.html" class="footer-link">Best for Hardwood Floors</a></li>
          <li><a href="${rootPath}posts/best-upright-vacuum-2026.html" class="footer-link">Best Upright Vacuums</a></li>
        </ul>
      </div>
